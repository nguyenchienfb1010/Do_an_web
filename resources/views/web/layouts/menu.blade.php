    ...
    <div class="container">
        <div class="header-grid">
            <div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                ...
                <ul>
                    <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="">Eshopper@gmail.com</a>
                    </li>
                    <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+84 382 780 326</li>
        ...
        <div class="logo-nav">
            <div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
                <a href="index.html"><img src="eshop/images/home/logo.png" alt="" /></a>
            </div>
                                                ...
                                                @if ($item2->parent_id == $item->id)
                                                    <div class="col-sm-4">
                                                        <ul class="multi-column-dropdown">
                                                            <h6><a
                                                                    href="{{ route('web.category') }}">{{ $item2->name }}</a>
                                                            </h6>
                                                            @foreach ($categories_3 as $item3)
                                                                @if ($item3->parent_id == $item2->id)
                                                                    <li><a
                                                                            href="{{ route('/web.category') }}">{{ $item3->name }}</a>
                                                                    </li>
                                                                @endif
                                                            @endforeach
                                                        </ul>
            ...
            <div class="header-right">
                <div class="cart box_1" style="background-color: white">
