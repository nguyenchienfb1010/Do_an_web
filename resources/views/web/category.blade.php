                    ...
                    <div class="new-products-grid">
                        <div class="new-products-grid-left">
                            ...
                            <div class="simpleCart_shelfItem new-products-grid-right-add-cart">
                                <p> <span class="item_price">{{($product->price)}} VND</span>
                                    <a class="item_add add_to_cart"  data-url={{ route('add_Cart', $product->id) }} href="#" style="background-color: orange; color:white">add to cart </a>
                                </p>
                            </div>
                        </div>
